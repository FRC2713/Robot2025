...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.addRoutine("scoreLotsOfCoralAndSource", autoRoutines::scoreLotsOfCoralAndSource);
    ...
    // autoChooser.addRoutine("*Score Once", autoRoutines::sc);
  ...
  private void configureButtonBindings() {
    ...
    // Grab Algae
    driver.rightBumper().onTrue(Commands.sequence(SuperStructure.ALGAE_GRAB.getCommand())).onFalse(AlgaeClawCmds.setSpeed(() -> 0));
