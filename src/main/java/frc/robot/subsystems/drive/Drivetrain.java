...
public class Drivetrain extends SubsystemBase {
  ...
  private boolean demoMode = SmartDashboard.getBoolean("demo mode", true);
  @Override
  ...
  public void runVelocity(ChassisSpeeds speeds) {
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(setpointStates, (demoMode)? TunerConstants.kSpeedAt12VoltsDemoMode : TunerConstants.kSpeedAt12Volts);
  ...
  public double getMaxLinearSpeedMetersPerSec() {
    return (demoMode)? TunerConstants.kSpeedAt12VoltsDemoMode.in(MetersPerSecond) : TunerConstants.kSpeedAt12Volts.in(MetersPerSecond);
  }
