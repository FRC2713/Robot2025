...
public class ClimberConstants {
  ...
  public static TalonFXConfiguration createKrakenConfig() {
    ...
    config.Feedback.SensorToMechanismRatio = ClimberConstants.kGearing;
    config.TorqueCurrent.PeakForwardTorqueCurrent = ClimberConstants.kStallCurrentLimit;
    config.TorqueCurrent.PeakReverseTorqueCurrent = -ClimberConstants.kStallCurrentLimit;
    config.CurrentLimits.StatorCurrentLimit = ClimberConstants.kStatorCurrentLimit;
    config.CurrentLimits.StatorCurrentLimitEnable = true;
    config.MotorOutput.Inverted =
        (ClimberConstants.kInverted)
