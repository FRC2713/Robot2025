...
public class TunerConstants {
  ...
  private static final double kSteerInertia = 0.004; // from AdvantageKit
  private static final double kDriveInertia = 0.025; // from AdvantageKit
