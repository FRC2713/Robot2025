...
public class CommandVader4Controller extends CommandGenericHID {
   ...
   *
   * @return a Trigger instance representing the M1 button's digital signal attached to the {@link
   *     CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #m1(EventLoop)
   */
  public Trigger m1() {
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the M1 button's digital signal attached to the given
   *     loop.
   */
   ...
   *
   * @return a Trigger instance representing the M2 button's digital signal attached to the {@link
   *     CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #m2(EventLoop)
   */
  public Trigger m2() {
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the M2 button's digital signal attached to the given
   *     loop.
   */
   ...
   *
   * @return a Trigger instance representing the M3 button's digital signal attached to the {@link
   *     CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #m3(EventLoop)
   */
  public Trigger m3() {
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the M3 button's digital signal attached to the given
   *     loop.
   */
   ...
   *
   * @return a Trigger instance representing the M4 button's digital signal attached to the {@link
   *     CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #m4(EventLoop)
   */
  public Trigger m4() {
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the M4 button's digital signal attached to the given
   *     loop.
   */
