...
public class IntakeCmds {
    ...
    public static Command enableLimitSwitch(BooleanSupplier setEnable) {
        return new InstantCommand(() -> RobotContainer.endEffector.setEnableLimitSwitch(setEnable.getAsBoolean()));
    }
    ...
    public static Command setAngle(DoubleSupplier targetAngle) {
        return new InstantCommand(() -> RobotContainer.intake.setTargetAngle(targetAngle.getAsDouble()));
    }
    ...
    public static Command setAngleAndWait(double targetAngle) {
        return Commands.sequence(
            IntakeCmds.setAngle(targetAngle),
            IntakeCmds.waitUntilAtTarget());
    }
