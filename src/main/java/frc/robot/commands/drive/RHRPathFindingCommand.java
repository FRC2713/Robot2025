...
public class RHRPathFindingCommand extends Command {
  ...
  public RHRPathFindingCommand(
    ...
    this.output = output;
    this.robotConfig = robotConfig;
    this.shouldFlipPath = () -> DriverStation.getAlliance().get() == Alliance.Red;
  ...
  public boolean isFinished() {
    ...
    if (targetPath != null && !targetPath.isChoreoPath()) {
      ...
      boolean withinStoppingDistance =
          currentPose.getTranslation().getDistance(targetPose.getTranslation()) <= stoppingDistance;
      if (withinStoppingDistance) {}
      return withinStoppingDistance;
    }
