...
public class PathfindToPose extends Command {
  ...
  public void initialize() {
    ...
    PathConstraints constraints =
        new PathConstraints(
            OTFConstants.pathConstraintVelocityMPS.getAsDouble(),
            OTFConstants.pathConstraintaccel.getAsDouble(),
    ...
    pathfindingCommand =
        AutoBuilder.pathfindToPose(
            targetPose,
            constraints,
            OTFConstants.endVel.getAsDouble() // Goal end velocity in meters/sec
            );
